...
def run_train(pred_df, fold):
    ...
    xtrain = train_df[["lr_pred", "rf_pred", "xgb_pred"]].values
    xvalid = valid_df[["lr_pred", "rf_pred", "xgb_pred"]].values
    ...
    valid_df.loc[:, "lr_prediction"] = preds
...
if __name__ == "__main__":
    ...
    print(metrics.roc_auc_score(fin_valid_df.target.values, fin_valid_df.lr_prediction.values))
